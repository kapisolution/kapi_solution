...
--
-- Host: localhost
-- Generation Time: Mar 19, 2018 at 06:04 PM
...
--
-- Table structure for table `Imagen_modificacion_articulo`
--
...
--
-- Dumping data for table `Modificacion_articulo`
--

INSERT INTO `Modificacion_articulo` (`id_mod`, `id`, `rol`, `nivel`, `titulo`, `contenido`, `creador`, `fecha`) VALUES
(1, 358, 'abogado', 1, '\r\n                dolor egestas rhoncus. Proin nisl sem, consequat nec, mollis vitae,              ', 'urna. Vivamus molestie dapibus ligula. Aliquam erat volutpat. Nulla dignissim. Maecenas ornare egestas ligula. Nullam feugiat placerat velit. Quisque varius. Nam porttitor scelerisque neque. Nullam nisl. Maecenas malesuada fringilla est. Mauris eu turpis. Nulla aliquet. Proin velit. Sed malesuada augue ut lacus. Nulla tincidunt, neque vitae semper egestas, urna justo faucibus lectus, a sollicitudin orci sem eget massa. Suspendisse eleifend. Cras sed leo. Cras vehicula aliquet libero. Integer in magna. Phasellus dolor elit, pellentesque a, facilisis non, bibendum sed, est. Nunc laoreet lectus quis massa. Mauris vestibulum, neque', 'javi', '2018-03-15 18:29:30'),
(2, 712, 'abogado', 1, 'undefined', 'undefined', 'javi', '2018-03-15 18:30:44'),
(3, 0, '', 0, '', '', 'javi', '2018-03-15 18:32:44'),
(4, 358, 'abogado', 1, '\r\n                dolor egestas rhoncus. Proin nisl sem, consequat nec, mollis vitae,              ', '<p><strong>urna. Vivamus molestie dapibus ligula. Aliquam erat volutpat. Nulla dignissim. Maecenas ornare egestas ligula. Nullam feugiat placerat velit. Quisque varius. Nam porttitor scelerisque neque. Nullam nisl. Maecenas malesuada fringilla est. Mauris eu turpis. Nulla aliquet. Proin velit. Sed malesuada augue ut lacus. Nulla tincidunt, neque vitae semper egestas, urna justo faucibus lectus, a sollicitudin orci sem eget massa. Suspendisse eleifend. Cras sed leo. Cras vehicula aliquet libero. Integer in magna. Phasellus dolor elit, pellentesque a, facilisis non, bibendum sed, est. Nunc laoreet lectus quis massa. Mauris vestibulum, neque</strong></p>', 'javi', '2018-03-15 18:32:44'),
(5, 0, '', 0, '', '', 'javi', '2018-03-15 18:35:51'),
(6, 888, 'abogado', 1, '\r\n                dictum eu, eleifend nec, malesuada ut, sem. Nulla interdum. Curabitur              ', 'orci, consectetuer euismod est arcu ac orci. Ut semper pretium neque. Morbi quis urna. Nunc quis arcu vel quam dignissim pharetra. Nam ac nulla. In tincidunt congue turpis. In condimentum. Donec at arcu. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec tincidunt. Donec vitae erat vel pede blandit congue. In scelerisque scelerisque dui. Suspendisse ac metus vitae velit egestas', 'javi', '2018-03-15 18:35:51'),
(7, 0, '', 0, '', '', 'javi', '2018-03-15 18:36:35'),
(8, 822, 'periodista', 2, '\r\n                velit justo nec ante. Maecenas mi felis, adipiscing fringilla, porttitor              ', 'dolor. Donec fringilla. Donec feugiat metus sit amet ante. Vivamus non lorem vitae odio sagittis semper. Nam tempor diam dictum sapien. Aenean massa. Integer vitae nibh. Donec est mauris, rhoncus id, mollis nec, cursus a, enim. Suspendisse aliquet, sem ut cursus luctus, ipsum', 'javi', '2018-03-15 18:36:35');
...
--
-- Indexes for table `Imagen_articulo`
--
ALTER TABLE `Imagen_articulo`
  ADD PRIMARY KEY (`id`,`path`);

--
-- Indexes for table `Imagen_modificacion_articulo`
--
...
--
-- AUTO_INCREMENT for table `Modificacion_articulo`
--
ALTER TABLE `Modificacion_articulo`
  MODIFY `id_mod` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
