...
if(isset($_GET["id"])&&$_GET["id"]!=""){ 
    ...
    /*
    Consulta para preparar los datos de la creacion del articulo
    ...
    */
    ...
    $sql ="SELECT * FROM Modificacion_articulo a, Modificaciones m WHERE a.id_mod = '".$id."' AND a.id_mod = m.id_modificacion;";
	$consulta = mysqli_query($con, $sql) or die("Error en consulta sobre la tabla polla, ". mysqli_error($con) . " " . $sql);
    ...
    */
    $sql ="SELECT * FROM Modificacion_pregunta WHERE id_mod = '".$id ."';";
