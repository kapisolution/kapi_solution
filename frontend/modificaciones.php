<?php
    include 'backend/modificaciones.php';
    $array=$articulos;
    $contador=0;
...
<div class="container">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">modificaciones</a></li>
        </ol>
                    ...
                    <div id="panel<?php echo $i?>" class="panel panel-default" <?php if($i>4){?>style="display:none"<?php } ?>>
                        ...
                        <div class="panel-body">
                            ...
                            <div id="titulo<?php echo $i ?>" class="tituloBody text-center">
                                <a id="refArt<?php echo $i ?>" href="modificacion.php?id=<?php echo $articulos[$i]['id_mod'];?>"><?php echo $articulos[$i]['titulo'];?></a>
                            </div>    
                        </div>
                        <div class="accion pull-right">
                            ...
                            <li><a id="verArt<?php echo $i ?>" <?php if((!isset($_SESSION['login']))){?>class="dropdown-item disabled"<?php } else{ ?> class="dropdown-item" href="/modificacion.php?id=<?php echo $articulos[$i]['id_mod']?>" <?php } ?>>Ver</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
