    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <div class="list-group">
                <button id="usr" type="button"  class="list-group-item" onclick="mostrarTarjetas(event, 'usuarios', 'usr')">
                    Usuarios
                </button>
                <button id="art" type="button" class="list-group-item" onclick="mostrarTarjetas(event, 'articulos', 'art')">Articulos</button>
                <button type="button" class="list-group-item">Creaciones</button>
                <button type="button" class="list-group-item">Modificaciones</button>
            </div>
